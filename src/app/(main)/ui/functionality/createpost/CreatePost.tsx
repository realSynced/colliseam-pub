...
import { AreaContext, TagsContext } from "./Contexts";
import Header from "./Header";
import WritingArea from "./WritingArea";
import { v4 as uuidv4 } from "uuid";
import type { Area, AreaContextValue, HeaderData, PostEntries, TagsContextValue } from "./types";
import { useUser } from "@/lib/store/user";

import { Modal, ModalContent } from "@nextui-org/react";
import { toast } from "sonner";
export default function CreatePost({ closeCreatePost }: { closeCreatePost: Function }) {
  ...
  async function submitPost() {
    ...
    if (user) {
      ...
      if (postError) {
        throw new Error("Could not post: " + postError.message);
      }
  ...
  return (
    ...
    >
      ...
      <div className="mt-5 flex flex-row justify-between">
        ...
        <button
          type="button"
          disabled={!submitable || disableButton}
          onClick={() => submitPost()}
